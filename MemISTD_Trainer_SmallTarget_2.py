...
def fit_one_epoch(
    ...
    for iteration, batch in enumerate(train_loader):
        ...
        has_gt = any(len(boxes) > 0 for boxes in boxes_list)
        if not has_gt:
            continue
        # ==================== 临时测试代码 - 结束 ====================
        ...
        total_loss_bg_inpaint += loss_bg_inpaint.item() if isinstance(loss_bg_inpaint, torch.Tensor) else 0
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="./config/memistd_nudt_config.yaml",
        # default="./config/memistd_itsdt_config.yaml",
        help="Path to config file",
    )
    parser.add_argument(
        "--resume",
        type=str,
        # default="./checkpoint/20260312_154828",
        # default="./checkpoint/20260318_163321",
        default="./checkpoint/20260320_195725",
        # default=None,
